...
const initiatorFactorOneData: projectDataType = {
  path: "initiatorfactorone",
  title: "Initiator Factor One",
  coverImage:
  ...
  description:
    "Music video for the song Initiator Factor One, by experimental musician Lazurite.",
...
export default initiatorFactorOneData;
